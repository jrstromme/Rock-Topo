...
- (IBAction)accessPhotoLibrary:(id)sender {
    ...
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypePhotoLibrary]) {
        self.photoLibrary.sourceType = UIImagePickerControllerSourceTypePhotoLibrary;
        
        [self presentViewController:self.photoLibrary animated:YES completion:nil];
    }
}
		...
		else
		{
			...
			dispatch_async(dispatch_get_main_queue(), ^{
				[[[UIAlertView alloc] initWithTitle:@"AVCam!"
											message:@"Rock-Topo doesn't have permission to use Camera, please change privacy settings"
										   delegate:self
